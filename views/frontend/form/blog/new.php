...
<div id="new_article">
	...
	<div class="form-item">
        ...
        <div id="blog_title-error" class="error <?php echo (isset($errors['title'])) ? '' : 'hide '?> hint">Поле заголовок не может быть пустым</div>
		<?php echo Form::input('article[title]', $post['article']['title'], array('id' => 'blog_title', 'class' => 'needle'))?>
	</div>
	<div class="form-item">
		<?php echo Form::label('blog_text', 'Текст (*)')?>
        <div id="blog_text-error" class="error <?php echo (isset($errors['text'])) ? '' : 'hide '?>hint">Поле текст не может быть пустым</div>
